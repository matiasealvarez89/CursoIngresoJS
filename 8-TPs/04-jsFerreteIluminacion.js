...
function CalcularPrecio() {
    ...
    precioConDescuento = cantidadLamparas * PRECIO_INICIAL - (cantidadLamparas * PRECIO_INICIAL * descuento / 100);


    if (precioConDescuento > 120) { //Punto d
        impuesto = precioConDescuento * 10 / 100;
        document.getElementById("txtIdprecioDescuento").value = precioConDescuento + impuesto;
